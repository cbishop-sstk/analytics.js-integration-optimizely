...
var Optimizely = module.exports = integration('Optimizely')
  ...
  .option('attributesFormatter', function (event, attributes){ return attributes; });
...
Optimizely.prototype.track = function(track) {
  ...
  push(['trackEvent', eventName, payload]);
  ...
  if (optimizelyClientInstance && optimizelyClientInstance.track) {
    ...
    var attributesFormatter = optimizelyOptions.attributesFormatter || this.options.attributesFormatter;
    attributes = attributesFormatter(eventName, attributes);
    var userId = optimizelyOptions.userId || track.userId();
    if (userId) {
      optimizelyClientInstance.track(eventName, userId, attributes, payload.revenue);
    }
  }
};
